    ...
    HealthNews() {
        return this.state.allNews.map((data, i) => {
            return (
                ...
                //             <img className="card-img-top" src={`${data.image === undefined ? newsImage : data.image.thumbnail.contentUrl}`} alt="how relax" />
                //         </div>
    ...
    render() {
        return (
            <div className="container">
                ...
                <h3 className="text-bold m-2 p-2">Lates Health News </h3>
                <div className="row">
